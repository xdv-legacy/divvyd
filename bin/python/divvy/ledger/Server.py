...
from divvy.ledger import DatabaseReader, DivvydReader
from divvy.ledger.Args import ARGS
from divvy.util.FileCache import FileCache
from divvy.util import ConfigFile
...
class Server(object):
    def __init__(self):
        ...
        if ARGS.database != ARGS.NONE:
            ...
            reader = DivvydReader.DivvydReader(self.config)
