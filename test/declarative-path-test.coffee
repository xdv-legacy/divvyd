...
create_path_test = (pth) ->
  return (done) ->
    ...
    sent = "TODO: need to patch divvy-lib"
    ...
    # self.server.clear_logs() "TODO: need to patch divvy-lib"
    ...
    ledger:
      accounts:
        ...
        M1:
          ...
          # can charge a fee when transactions divvy across. Liquitidy
  ...
  "Path Tests #2 (non-XDV to non-XDV, same currency)": {
    ...
    paths_expected: {
      T4:
        ...
        "F) Different gateways, divvy  _skip":
          comment: 'Source -> AC -> AC -> Destination'

        "G) Different users of different gateways, divvy  _skip":
